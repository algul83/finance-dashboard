...
if billed.empty:
    ...
    _CHEONGAN_COLOR = {
        0: "#93C5FD",  # 갑(甲) 木 — 파스텔 청
        1: "#99E3D6",  # 을(乙) 木 — 파스텔 청록
        2: "#FCA5A5",  # 병(丙) 火 — 파스텔 적
        3: "#FDBA74",  # 정(丁) 火 — 파스텔 주홍
        4: "#FDE68A",  # 무(戊) 土 — 파스텔 황금
        5: "#FCD9A0",  # 기(己) 土 — 파스텔 황
        6: "#D1D5DB",  # 경(庚) 金 — 파스텔 은회
        7: "#CBD5E1",  # 신(辛) 金 — 파스텔 회
